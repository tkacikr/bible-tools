(function() {
  ...
  bcv_parser.prototype.regexps.translations = /(?:(?:NEG1979|LSG(?:21)?|BDS))\b/gi;
  ...
  bcv_parser.prototype.regexps.escaped_passage = RegExp(`(?:^|[^\\x1f\\x1e\\dA-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:ch(?:apters?|a?pts?\\.?|a?p?s?\\.?)?\\s*\\d+\\s*(?:[\\u2013\\u2014\\-]|through|thru|to)\\s*\\d+\\s*(?:from|of|in)(?:\\s+the\\s+book\\s+of)?\\s*)|(?:ch(?:apters?|a?pts?\\.?|a?p?s?\\.?)?\\s*\\d+\\s*(?:from|of|in)(?:\\s+the\\s+book\\s+of)?\\s*)|(?:\\d+(?:th|nd|st)\\s*ch(?:apter|a?pt\\.?|a?p?\\.?)?\\s*(?:from|of|in)(?:\\s+the\\s+book\\s+of)?\\s*))?\\x1f(\\d+)(?:/\\d+)?\\x1f(?:/\\d+\\x1f|[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014]|titre(?![a-z])|et(?!${bcv_parser.prototype.regexps.space // Beginning of string or not in the middle of a word or immediately following another book. Only count a book if it's part of a sequence: `Matt5John3` is OK, but not `1Matt5John3`
...
}+suivant)|et${bcv_parser.prototype.regexps.space}+suivant|chapitres|chapitre|comparer|versets|verset|chap|vers|chs|ver|ch|vv|á|v|[a-e](?!\\w)|$)+)`, "gi");

  // These are the only valid ways to end a potential passage match. The closing parenthesis allows for fully capturing parentheses surrounding translations (ESV**)**. The last one, `[\d\x1f]` needs not to be +; otherwise `Gen5ff` becomes `\x1f0\x1f5ff`, and `adjust_regexp_end` matches the `\x1f5` and incorrectly dangles the ff.
  bcv_parser.prototype.regexps.match_end_split = RegExp(`\\d\\W*titre|\\d\\W*et${bcv_parser.prototype.regexps.space //ff09 is a full-width closing parenthesis
}+suivant(?:[\\s\\xa0*]*\\.)?|\\d[\\s\\xa0*]*[a-e](?!\\w)|\\x1e(?:[\\s\\xa0*]*[)\\]\\uff09])?|[\\d\\x1f]`, "gi");
  ...
  bcv_parser.prototype.regexps.get_books = function(include_apocrypha, case_sensitive) {
    ...
    books = [
      ...
      {
        osis: ["Gen"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:G(?:e(?:n(?:[e\\xE8]se)?)?|n)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Exod"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ex(?:o(?:de?)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Bel"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Bel(?:[\\s\\xa0]*et[\\s\\xa0]*le[\\s\\xa0]*(?:[Ss]erpent|[Dd]ragon))?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Lev"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:L(?:[e\\xE9](?:v(?:itique)?)?|v)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Num"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:N(?:o(?:m(?:b(?:res)?)?)?|um|[bm])))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Sir"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:La[\\s\\xa0]*Sagesse[\\s\\xa0]*de[\\s\\xa0]*Ben[\\s\\xa0]*Sira|Sagesse[\\s\\xa0]*de[\\s\\xa0]*Ben[\\s\\xa0]*Sira|(?:Eccl[e\\xE9]siastiqu|Siracid)e|Sir?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Wis"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:S(?:agesse(?:[\\s\\xa0]*de[\\s\\xa0]*Salomon)?|g)|Wis))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Lam"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:L(?:a(?:m(?:entations(?:[\\s\\xa0]*de[\\s\\xa0]*J[e\\xE9]r[e\\xE9]mie)?)?)?|m)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["EpJer"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:\\xC9p(?:[i\\xEE]tre[\\s\\xa0]*de[\\s\\xa0]*J[e\\xE9]r[e\\xE9]mie|(?:\\.[\\s\\xa0]*J[e\\xE9]r[e\\xE9]|[\\s\\xa0]*J[e\\xE9]r[e\\xE9])mie|(?:\\.[\\s\\xa0]*J[e\\xE9]|[\\s\\xa0]*J[e\\xE9])r)|Ep(?:[i\\xEE]tre[\\s\\xa0]*de[\\s\\xa0]*J[e\\xE9]r[e\\xE9]mie|(?:\\.[\\s\\xa0]*J[e\\xE9]r[e\\xE9]|[\\s\\xa0]*J[e\\xE9]r[e\\xE9])mie|(?:\\.[\\s\\xa0]*J[e\\xE9]|[\\s\\xa0]*J[e\\xE9]|Je)r)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Rev"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ap(?:o(?:c(?:alypse(?:[\\s\\xa0]*de[\\s\\xa0]*Jean)?)?)?|c)?|Rev))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["PrMan"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:La[\\s\\xa0]*Pri[e\\xE8]re[\\s\\xa0]*de[\\s\\xa0]*Manass[e\\xE9]|Pr(?:i[e\\xE8]re[\\s\\xa0]*de[\\s\\xa0]*Manass[e\\xE9]|\\.?[\\s\\xa0]*Manass[e\\xE9]|(?:\\.?[\\s\\xa0]*)?Man)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Deut"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:D(?:eu(?:t(?:[e\\xE9]ronome)?)?|t)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Josh"],
      ...
      {
        osis: ["Judg"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:J(?:u(?:g(?:es)?|dg)|g)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Ruth"],
      ...
      },
      {
        osis: ["1Esd"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Premi(?:\xE8res?|er(?:es?|s)?)[\s\xa0]*Esdras|(?:1(?:\xE8?re|ere?)?|I)\.[\s\xa0]*Esdras|(?:1(?:\xE8?re|ere?)|I)[\s\xa0]*Esdras|1(?:[\s\xa0]*Esdras|[\s\xa0]*Es(?:dr?)?|Esd)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2Esd"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Deuxi[e\xE8]mes?[\s\xa0]*Esdras|(?:2(?:\xE8me|e(?:me)?|de|d)?|II)\.[\s\xa0]*Esdras|(?:2(?:\xE8me|e(?:me)?|de?)|II)[\s\xa0]*Esdras|2(?:[\s\xa0]*Esdras|[\s\xa0]*Es(?:dr?)?|Esd)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Isa"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:[EI\\xC9]s(?:a(?:[i\\xEF]e)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Sam"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Deuxi[e\xE8]mes?[\s\xa0]*Samuel|(?:2(?:\xE8me|e(?:me)?|de|d)?|II)\.[\s\xa0]*Samuel|(?:2(?:\xE8me|e(?:me)?|de?)|II)[\s\xa0]*Samuel|2(?:[\s\xa0]*Samuel|[\s\xa0]*S(?:am?)?|Sam)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Sam"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Premi(?:\xE8res?|er(?:es?|s)?)[\s\xa0]*Samuel|(?:1(?:\xE8?re|ere?)?|I)\.[\s\xa0]*Samuel|(?:1(?:\xE8?re|ere?)|I)[\s\xa0]*Samuel|1(?:[\s\xa0]*Samuel|[\s\xa0]*S(?:am?)?|Sam)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2Kgs"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Deuxi[e\xE8]mes?[\s\xa0]*Rois|(?:2(?:\xE8me|e(?:me)?|de|d)?|II)\.[\s\xa0]*Rois|(?:2(?:\xE8me|e(?:me)?|de?)|II)[\s\xa0]*Rois|2(?:[\s\xa0]*Rois|Kgs|[\s\xa0]*R)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Kgs"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Premi(?:\xE8res?|er(?:es?|s)?)[\s\xa0]*Rois|(?:1(?:\xE8?re|ere?)?|I)\.[\s\xa0]*Rois|(?:1(?:\xE8?re|ere?)|I)[\s\xa0]*Rois|1(?:[\s\xa0]*Rois|Kgs|[\s\xa0]*R)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2Chr"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Deuxi[e\xE8]mes?[\s\xa0]*Chroniques|(?:2(?:\xE8me|e(?:me)?|de|d)?|II)\.[\s\xa0]*Chroniques|(?:2(?:\xE8me|e(?:me)?|de?)|II)[\s\xa0]*Chroniques|2(?:[\s\xa0]*Chroniques|[\s\xa0]*Ch(?:r(?:on?)?)?|Chr)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Chr"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Premi(?:\xE8res?|er(?:es?|s)?)[\s\xa0]*Chroniques|(?:1(?:\xE8?re|ere?)?|I)\.[\s\xa0]*Chroniques|(?:1(?:\xE8?re|ere?)|I)[\s\xa0]*Chroniques|1(?:[\s\xa0]*Chroniques|[\s\xa0]*Ch(?:r(?:on?)?)?|Chr)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Ezra"],
      ...
      {
        osis: ["Neh"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:N[e\\xE9](?:h(?:[e\\xE9]mie)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["GkEsth"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Esth(?:er[\\s\\xa0]*(?:\\([Gg]rec\\)|[Gg]rec|[Gg]r)|[\\s\\xa0]*[Gg]r)|GkEsth))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Esth"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Est(?:h(?:er)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Job"],
      ...
      {
        osis: ["Ps"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ps(?:a(?:u(?:mes?)?)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["PrAzar"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:La[\\s\\xa0]*Pri[e\\xE8]re[\\s\\xa0]*d['’]Azaria[hs]|Pr(?:i[e\\xE8]re[\\s\\xa0]*d['’]Azaria[hs]|(?:\\.[\\s\\xa0]*|[\\s\\xa0]*)?Azar)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Prov"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Pr(?:o(?:v(?:erbes)?)?|v)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Eccl"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ec(?:cl(?:[e\\xE9]s(?:iaste)?)?)?|Qoheleth?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["SgThree"],
      ...
      {
        osis: ["Song"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:C(?:a(?:ntique(?:[\\s\\xa0]*des[\\s\\xa0]*[Cc]antiques|s)?)?|n?t)|Song))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Jer"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:J(?:[e\\xE9](?:r(?:[e\\xE9]m(?:ie)?)?)?|r)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Ezek"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:\\xC9z[e\\xE9]ch(?:iel)?|Ez(?:\\xE9ch(?:iel)?|e(?:ch(?:iel)?|k)?|\\xE9)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Dan"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:D(?:a(?:n(?:iel)?)?|n)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Hos"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Os(?:[e\\xE9]e)?|Hos))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Joel"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:J(?:o[e\\xEB]l?|l)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Amos"],
      ...
      {
        osis: ["Obad"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ab(?:d(?:ias)?)?|Obad))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Jonah"],
      ...
      {
        osis: ["Mic"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Mi(?:c(?:h(?:[e\\xE9]e)?)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Nah"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Na(?:h(?:oum|um)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Hab"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ha(?:b(?:a(?:quq|kuk|c(?:uc)?|k))?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Zeph"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:So(?:ph(?:onie)?)?|Zeph))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Hag"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ag(?:g(?:[e\\xE9]e)?)?|Hag))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Zech"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Z(?:a(?:c(?:c(?:h(?:arie)?)?|h(?:arie)?)?|h)?|ech|c)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Mal"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:M(?:al(?:ac(?:h(?:ie)?)?|ch|c)?|l)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Matt"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:M(?:at(?:t(?:h(?:ieu)?)?)?|t)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Mark"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:M(?:ar[ck]?|[cr])))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Luke"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:L(?:u(?:ke|c)?|c)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["1John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:Premi(?:\xE8res?|er(?:es?|s)?)[\s\xa0]*Jea|(?:1(?:\xE8?re|ere?)?|I)\.[\s\xa0]*Jea|(?:1(?:\xE8?re|ere?)|I)[\s\xa0]*Jea|1(?:[\s\xa0]*Jea|Joh|[\s\xa0]*J))n))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:Deuxi[e\xE8]mes?[\s\xa0]*Jea|(?:2(?:\xE8me|e(?:me)?|de|d)?|II)\.[\s\xa0]*Jea|(?:2(?:\xE8me|e(?:me)?|de?)|II)[\s\xa0]*Jea|2(?:[\s\xa0]*Jea|Joh|[\s\xa0]*J))n))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["3John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:Troisi[e\xE8]mes?[\s\xa0]*Jea|(?:3(?:\xE8me|e(?:me)?)?|III)\.[\s\xa0]*Jea|(?:3(?:\xE8me|e(?:me)?)|III)[\s\xa0]*Jea|3(?:[\s\xa0]*Jea|Joh|[\s\xa0]*J))n))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["John"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:J(?:oh|ea)?n))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Acts"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ac(?:t(?:es(?:[\\s\\xa0]*des[\\s\\xa0]*Ap[o\\xF4]tres)?|s)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Rom"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:R(?:o(?:m(?:ains)?)?|m)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Deuxi[e\xE8]mes?[\s\xa0]*Corinthiens|(?:2(?:\xE8me|e(?:me)?|de|d)?|II)\.[\s\xa0]*Corinthiens|(?:2(?:\xE8me|e(?:me)?|de?)|II)[\s\xa0]*Corinthiens|2(?:[\s\xa0]*Corinthiens|[\s\xa0]*Cor?|Cor)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Premi(?:\xE8res?|er(?:es?|s)?)[\s\xa0]*Corinthiens|(?:1(?:\xE8?re|ere?)?|I)\.[\s\xa0]*Corinthiens|(?:1(?:\xE8?re|ere?)|I)[\s\xa0]*Corinthiens|1(?:[\s\xa0]*Corinthiens|[\s\xa0]*Cor?|Cor)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Gal"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:G(?:a(?:l(?:ates)?)?|l)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Eph"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:[E\\xC9]p(?:h(?:[e\\xE9](?:s(?:iens)?)?)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Phil"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ph(?:il(?:ippiens)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Col"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Col(?:ossiens)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Deuxi[e\xE8]me(?:s[\s\xa0]*Thess?|[\s\xa0]*Thess?)aloniciens|(?:2(?:\xE8me|e(?:me)?|de|d)?|II)\.[\s\xa0]*Thess?aloniciens|(?:2(?:\xE8me|e(?:me)?|de?)|II)[\s\xa0]*Thess?aloniciens|2(?:[\s\xa0]*Thess?aloniciens|[\s\xa0]*Th(?:ess?)?|Thess)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Premi(?:\xE8re(?:s[\s\xa0]*Thess?|[\s\xa0]*Thess?)|er(?:e(?:s[\s\xa0]*Thess?|[\s\xa0]*Thess?)|s[\s\xa0]*Thess?|[\s\xa0]*Thess?))aloniciens|(?:1(?:\xE8?re|ere?)?|I)\.[\s\xa0]*Thess?aloniciens|(?:1(?:\xE8?re|ere?)|I)[\s\xa0]*Thess?aloniciens|1(?:[\s\xa0]*Thess?aloniciens|[\s\xa0]*Th(?:ess?)?|Thess)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2Tim"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Deuxi[e\xE8]me(?:s[\s\xa0]*Timoth[e\xE9]|[\s\xa0]*Timoth[e\xE9])e|(?:2(?:\xE8me|e(?:me)?|de|d)?|II)\.[\s\xa0]*Timoth[e\xE9]e|(?:2(?:\xE8me|e(?:me)?|de?)|II)[\s\xa0]*Timoth[e\xE9]e|2(?:[\s\xa0]*Timoth[e\xE9]e|[\s\xa0]*Tim?|(?:Ti|[\s\xa0]*T)m)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Tim"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Premi(?:\xE8re(?:s[\s\xa0]*Timoth[e\xE9]|[\s\xa0]*Timoth[e\xE9])|er(?:e(?:s[\s\xa0]*Timoth[e\xE9]|[\s\xa0]*Timoth[e\xE9])|s[\s\xa0]*Timoth[e\xE9]|[\s\xa0]*Timoth[e\xE9]))e|(?:1(?:\xE8?re|ere?)?|I)\.[\s\xa0]*Timoth[e\xE9]e|(?:1(?:\xE8?re|ere?)|I)[\s\xa0]*Timoth[e\xE9]e|1(?:[\s\xa0]*Timoth[e\xE9]e|[\s\xa0]*Tim?|(?:Ti|[\s\xa0]*T)m)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Titus"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:T(?:it(?:us|e)?|t)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Phlm"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ph(?:il[e\\xE9]mon|l?m)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Heb"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:H[e\\xE9](?:b(?:r(?:eux)?)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Jas"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:J(?:a(?:c(?:q(?:ues)?)?|ques|s)?|c)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Pet"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2Pet)|(?:Deuxi[e\xE8]mes?[\s\xa0]*Pierre|(?:2(?:\xE8me|e(?:me)?|de|d)?|II)\.[\s\xa0]*Pierre|(?:2(?:\xE8me|e(?:me)?|de?)|II)[\s\xa0]*Pierre|2[\s\xa0]*P(?:ierre|ie?)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Pet"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1Pet)|(?:Premi(?:\xE8res?|er(?:es?|s)?)[\s\xa0]*Pierre|(?:1(?:\xE8?re|ere?)?|I)\.[\s\xa0]*Pierre|(?:1(?:\xE8?re|ere?)|I)[\s\xa0]*Pierre|1[\s\xa0]*P(?:ierre|ie?)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Jude"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:J(?:ude?|d)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Tob"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:T(?:ob(?:ie)?|b)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Jdt"],
      ...
      },
      {
        osis: ["Bar"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ba(?:r(?:uch)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Sus"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Su[sz](?:anne(?:[\\s\\xa0]*(?:et[\\s\\xa0]*les[\\s\\xa0]*(?:deux[\\s\\xa0]*)?vieillards|au[\\s\\xa0]*bain))?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Deuxi[e\xE8]me(?:s[\s\xa0]*Maccab[e\xE9]|[\s\xa0]*Maccab[e\xE9])es|(?:2(?:\xE8me|e(?:me)?|de|d)?|II)\.[\s\xa0]*Maccab[e\xE9]es|(?:2(?:\xE8me|e(?:me)?|de?)|II)[\s\xa0]*Maccab[e\xE9]es|2(?:[\s\xa0]*Maccab[e\xE9]es|[\s\xa0]*M(?:acc)?|Macc)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["3Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Troisi[e\xE8]me(?:s[\s\xa0]*Maccab[e\xE9]|[\s\xa0]*Maccab[e\xE9])es|(?:3(?:\xE8me|e(?:me)?)?|III)\.[\s\xa0]*Maccab[e\xE9]es|(?:3(?:\xE8me|e(?:me)?)|III)[\s\xa0]*Maccab[e\xE9]es|3(?:[\s\xa0]*Maccab[e\xE9]es|[\s\xa0]*M(?:acc)?|Macc)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["4Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Quatri[e\xE8]me(?:s[\s\xa0]*Maccab[e\xE9]|[\s\xa0]*Maccab[e\xE9])es|(?:4(?:\xE8me|e(?:me)?)?|IV)\.[\s\xa0]*Maccab[e\xE9]es|(?:4(?:\xE8me|e(?:me)?)|IV)[\s\xa0]*Maccab[e\xE9]es|4(?:[\s\xa0]*Maccab[e\xE9]es|[\s\xa0]*M(?:acc)?|Macc)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Premi(?:\xE8re(?:s[\s\xa0]*Maccab[e\xE9]|[\s\xa0]*Maccab[e\xE9])|er(?:e(?:s[\s\xa0]*Maccab[e\xE9]|[\s\xa0]*Maccab[e\xE9])|s[\s\xa0]*Maccab[e\xE9]|[\s\xa0]*Maccab[e\xE9]))es|(?:1(?:\xE8?re|ere?)?|I)\.[\s\xa0]*Maccab[e\xE9]es|(?:1(?:\xE8?re|ere?)|I)[\s\xa0]*Maccab[e\xE9]es|1(?:[\s\xa0]*Maccab[e\xE9]es|[\s\xa0]*M(?:acc)?|Macc)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Jonah",
      "Job",
      ...
      },
      {
        osis: ["Phil",
      "Phlm"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Phl?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      }
    ];

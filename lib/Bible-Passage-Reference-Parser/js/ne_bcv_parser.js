(function() {
  ...
  bcv_parser.prototype.regexps.range_and = "(?:[&\u2013\u2014-]|(?:and|र)|-)";
  ...
  bcv_parser.prototype.regexps.get_books = function(include_apocrypha, case_sensitive) {
    ...
    books = [
      ...
      {
        osis: ["Gen"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:उत्पत्ति(?:को(?:[\\s\\xa0]*पुस्तक)?)?|utpattiko[\\s\\xa0]*pustak|utpattiko|Gen))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Exod"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:प्रस्थानको[\\s\\xa0]*पुस्तक|prastʰ[aā]nko(?:[\\s\\xa0]*pustak)?|प्रस्थान(?:को)?|Exod))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Bel"],
      ...
      {
        osis: ["Lev"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:lev[iī]har[uū]ko(?:[\\s\\xa0]*pustak)?|ले(?:व(?:ीहरूको[\\s\\xa0]*पुस्तक|ि)|बी)|लेवी(?:हरूको)?|Lev))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Num"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:गन्तीको[\\s\\xa0]*पुस्तक|gant[iī]ko(?:[\\s\\xa0]*pustak)?|गन्ती(?:को)?|Num))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Sir"],
      ...
      {
        osis: ["Lam"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:यर्मियाको[\\s\\xa0]*विलाप|yarmiy[aā]ko[\\s\\xa0]*vil[aā]p|विलाप|Lam))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["EpJer"],
      ...
      {
        osis: ["Rev"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:y[uū]hann[aā]l[aā][iī][\\s\\xa0]*bʰaeko[\\s\\xa0]*prak[aā][sš]|यूहन्नालाई[\\s\\xa0]*भएको[\\s\\xa0]*प्रकाश|Rev)|(?:प्रकाश))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["PrMan"],
      ...
      {
        osis: ["Deut"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:vyavastʰ[aā]ko(?:[\\s\\xa0]*pustak)?|व्य(?:वस्थाको[\\s\\xa0]*पुस्तक|ावस्था)|व्यवस्था(?:को)?|Deut))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Josh"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:yaho[sš][uū]ko(?:[\\s\\xa0]*pustak)?|यहोशूको[\\s\\xa0]*पुस्तक|यहोशू(?:को)?|Josh))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Judg"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:न्यायकर्त(?:्त)?ाहरूको[\\s\\xa0]*पुस्तक|ny[aā]yakartt[aā]har[uū]ko[\\s\\xa0]*pustak|न्यायकर्ता|Judg)|(?:ny[aā]yakartt[aā]har[uū]ko|न्यायकर्त्ताहरूको))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Ruth"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:r[uū]tʰko(?:[\\s\\xa0]*pustak)?|रूथको[\\s\\xa0]*पुस्तक|रूथ(?:को)?|Ruth))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["1Esd"],
      ...
      {
        osis: ["Isa"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ya[sš]əiy[aā]ko(?:[\\s\\xa0]*pustak)?|य(?:शैयाको[\\s\\xa0]*पुस्तक|ेशैया)|यशैया(?:को)?|Isa))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Sam"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ꣠-ꣷꣻ])((?:शमूएलको[\s\xa0]*दोस्रो[\s\xa0]*पुस्तक|2(?:\.[\s\xa0]*(?:[sš]am[uū]elko|श(?:मूएलको|ामुएल))|[\s\xa0]*[sš]am[uū]elko|[\s\xa0]*शमूएलले|[\s\xa0]*शमूएलको|[\s\xa0]*शामुएल|Sam)|२[\s\xa0]*शमूएलले|2\.?[\s\xa0]*शमूएल))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Sam"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ꣠-ꣷꣻ])((?:शमूएलको[\s\xa0]*पहिलो[\s\xa0]*पुस्तक|[sš]am[uū]elko[\s\xa0]*pustak|1(?:\.[\s\xa0]*(?:[sš]am[uū]elko|श(?:मूएलको|ामुएल))|[\s\xa0]*[sš]am[uū]elko|[\s\xa0]*शमूएलले|[\s\xa0]*शमूएलको|[\s\xa0]*शामुएल|Sam)|१[\s\xa0]*शमूएलले|1\.?[\s\xa0]*शमूएल))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2Kgs"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ꣠-ꣷꣻ])((?:राजाहरूको[\s\xa0]*दोस्रो[\s\xa0]*पुस्तक|2(?:\.[\s\xa0]*(?:r[aā]ǳ[aā]har[uū]ko|राजाहरूको)|[\s\xa0]*(?:r[aā]ǳ[aā]har[uū]ko|राजाहरूको)|\.?[\s\xa0]*राजा|Kgs)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Kgs"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ꣠-ꣷꣻ])((?:राजाहरूक[\s\xa0]*पहिल[\s\xa0]*पुस्तक|r[aā]ǳ[aā]har[uū]ko[\s\xa0]*pustak|1(?:\.[\s\xa0]*(?:r[aā]ǳ[aā]har[uū]ko|राजाहरूको)|[\s\xa0]*(?:r[aā]ǳ[aā]har[uū]ko|राजाहरूको)|Kgs)|1\.?[\s\xa0]*राजा))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2Chr"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ꣠-ꣷꣻ])((?:इतिहासको[\s\xa0]*दोस्रो[\s\xa0]*पुस्तक|2(?:\.[\s\xa0]*(?:इतिहासको|itih[aā]sko)|[\s\xa0]*(?:इतिहासको|itih[aā]sko)|\.?[\s\xa0]*इतिहास|Chr)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Chr"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ꣠-ꣷꣻ])((?:इतिहासको[\s\xa0]*पहिलो[\s\xa0]*पुस्तक|itih[aā]sko[\s\xa0]*pustak|1(?:\.[\s\xa0]*(?:इतिहासको|itih[aā]sko)|[\s\xa0]*(?:इतिहासको|itih[aā]sko)|Chr)|1\.?[\s\xa0]*इतिहास))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Ezra"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:एज्रा(?:को(?:[\\s\\xa0]*पुस्तक)?)?|eǳr[aā]ko|Ezra))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Neh"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:न(?:हेम्याहको[\\s\\xa0]*पुस्तक|ेहमिया)|nahemy[aā]hko(?:[\\s\\xa0]*pustak)?|नहेम्याह(?:को)?|Neh))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["GkEsth"],
      ...
      {
        osis: ["Esth"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:एस्तरको[\\s\\xa0]*पुस्तक|estarko(?:[\\s\\xa0]*pustak)?|एस्तर(?:को)?|Esth))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Job"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:अय(?:्यूब(?:को(?:[\\s\\xa0]*पुस्तक)?)?|ूब)|ayy[uū]bko[\\s\\xa0]*pustak|ayy[uū]bko|Job))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Ps"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:bʰaǳansa[mṃ]grah|भजनसं?ग्रह|भजन|Ps))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["PrAzar"],
      ...
      {
        osis: ["Prov"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:hitopade[sš]ko(?:[\\s\\xa0]*pustak)?|हितोपदेशको[\\s\\xa0]*पुस्तक|हितोपदेश(?:को)?|Prov))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Eccl"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:upade[sš]akko(?:[\\s\\xa0]*pustak)?|उपदेशकको[\\s\\xa0]*पुस्तक|उपदेशक(?:को)?|Eccl))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["SgThree"],
      ...
      {
        osis: ["Song"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:सुलेमानको[\\s\\xa0]*श्रेष्ठगीत|sulem[aā]nko[\\s\\xa0]*[sš]re[sṣ][tṭ]ʰag[iī]t|Song)|(?:श्रेष्ठगीत))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Jer"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:यर्मियाको[\\s\\xa0]*पुस्तक|yarmiy[aā]ko(?:[\\s\\xa0]*pustak)?|यर्मिया(?:को)?|Jer))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Ezek"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:iǳakielko(?:[\\s\\xa0]*pustak)?|इजकिएल(?:को[\\s\\xa0]*पुस्तक|को)?|Ezek))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Dan"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:d[aā]niyalko(?:[\\s\\xa0]*pustak)?|दानि(?:यलको[\\s\\xa0]*पुस्तक|एल)|दानियल(?:को)?|Dan))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Hos"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:होशे(?:को[\\s\\xa0]*पुस्तक)?|ho[sš]e|Hos))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Joel"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:योएल(?:को[\\s\\xa0]*पुस्तक)?|[Jy]oel))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Amos"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:आमोस(?:को[\\s\\xa0]*पुस्तक)?|अमोस|[Aaā]mos))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Obad"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ओबदिया(?:को[\\s\\xa0]*पुस्तक)?|obadiy[aā]|Obad))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Jonah"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:योना(?:को[\\s\\xa0]*पुस्तक)?|Jonah|yon[aā]))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Mic"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:म(?:ीका(?:को[\\s\\xa0]*पुस्तक)?|िका)|m[iī]k[aā]|Mic))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Nah"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:नहूम(?:को[\\s\\xa0]*पुस्तक)?|nah[uū]m|Nah))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Hab"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:हबकूक(?:को[\\s\\xa0]*पुस्तक)?|habak[uū]k|Hab))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Zeph"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:सपन्याह(?:को[\\s\\xa0]*पुस्तक)?|(?:sapany[aā]|Zep)h))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Hag"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:ह(?:ाग्गै(?:को[\\s\\xa0]*पुस्तक)?|ग्गै)|h[aā]ggəi|Hag))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Zech"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:जकरिया(?:को[\\s\\xa0]*पुस्तक)?|jakariy[aā]|Zech))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Mal"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:मल(?:ाकी(?:को[\\s\\xa0]*पुस्तक)?|की)|mal[aā]k[iī]|Mal))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Matt"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:matt[iī]le(?:[\\s\\xa0]*lekʰeko[\\s\\xa0]*susm[aā]c[aā]r)?|मत्त(?:ी(?:ले[\\s\\xa0]*लेखे)?को[\\s\\xa0]*सुसमाचार|ि)|मत्ती(?:ले)?|Matt))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Mark"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:mark[uū]sle(?:[\\s\\xa0]*lekʰeko[\\s\\xa0]*susm[aā]c[aā]r)?|मर्क(?:ू(?:स(?:ले[\\s\\xa0]*लेखे)?को[\\s\\xa0]*सुसमाचार|श)|ुस)|मर्कूस(?:ले)?|र्मकूस|र्मकस|Mark))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Luke"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:l[uū]k[aā]le[\\s\\xa0]*lekʰeko[\\s\\xa0]*susm[aā]c[aā]r|ल(?:ूका(?:ले[\\s\\xa0]*लेखे)?को[\\s\\xa0]*सुसमाचार|ुका)|लूका|Luke)|(?:लूकाले|l[uū]k[aā]le))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["1John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ꣠-ꣷꣻ])((?:y[uū]hann[aā]ko[\s\xa0]*pahilo[\s\xa0]*patra|यूहन्नाको[\s\xa0]*पहिलो[\s\xa0]*पत्र|1(?:\.[\s\xa0]*(?:यूहन्नाको|y[uū]hann[aā]ko)|[\s\xa0]*(?:यूहन्नाको|y[uū]hann[aā]ko)|John)|1\.?[\s\xa0]*यूहन्ना))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ꣠-ꣷꣻ])((?:यूहन्नाको[\s\xa0]*दोस्(?:त्)?रो[\s\xa0]*पत्र|y[uū]hann[aā]ko[\s\xa0]*dostro[\s\xa0]*patra|2(?:\.[\s\xa0]*(?:यूहन्नाको|y[uū]hann[aā]ko)|[\s\xa0]*(?:यूहन्नाको|y[uū]hann[aā]ko)|John)|2\.?[\s\xa0]*यूहन्ना))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["3John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ꣠-ꣷꣻ])((?:यूहन्नाको[\s\xa0]*तेस्(?:त्)?रो[\s\xa0]*पत्र|y[uū]hann[aā]ko[\s\xa0]*testro[\s\xa0]*patra|3(?:\.[\s\xa0]*(?:यूहन्नाको|y[uū]hann[aā]ko)|[\s\xa0]*(?:यूहन्नाको|y[uū]hann[aā]ko)|John)|3\.?[\s\xa0]*यूहन्ना))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["John"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:y[uū]hann[aā]le[\\s\\xa0]*lekʰeko[\\s\\xa0]*susm[aā]c[aā]r|य(?:ूह(?:न(?:्ना(?:ले[\\s\\xa0]*लेखे)?को[\\s\\xa0]*सुसमाचार|ा)|ान्ना)|(?:ुह|हू)न्ना)|यूहन्ना|John)|(?:यूहन्नाले|y[uū]hann[aā]le))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Acts"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:प्रेरितहरूका[\\s\\xa0]*काम|prerithar[uū]k[aā][\\s\\xa0]*k[aā]m|प्रेरित|Acts))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Rom"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:रोमी(?:हरूलाई[\\s\\xa0]*प(?:ावलको[\\s\\xa0]*प)?त्र)?|rom[iī]har[uū]l[aā][iī][\\s\\xa0]*patra|Rom)|(?:rom[iī]har[uū]l[aā][iī]|रोमीहरूलाई))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ꣠-ꣷꣻ])((?:कोरिन्थीहरूलाई[\s\xa0]*(?:पावलको[\s\xa0]*दोस|दोस्त)्रो[\s\xa0]*पत्र|korintʰ[iī]har[uū]l[aā][iī][\s\xa0]*dostro[\s\xa0]*patra|2(?:\.[\s\xa0]*(?:korintʰ[iī]har[uū]l[aā][iī]|कोरिन्थीहरूलाई)|[\s\xa0]*korintʰ[iī]har[uū]l[aā][iī]|[\s\xa0]*कोरिन्थीहरूलाई|[\s\xa0]*कोरन्थी|Cor)|2\.?[\s\xa0]*कोरिन्थी|२[\s\xa0]*कोरन्थी))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ꣠-ꣷꣻ])((?:कोरिन्थीहरूलाई[\s\xa0]*प(?:ावलको[\s\xa0]*प)?हिलो[\s\xa0]*पत्र|korintʰ[iī]har[uū]l[aā][iī][\s\xa0]*pahilo[\s\xa0]*patra|1(?:\.[\s\xa0]*(?:korintʰ[iī]har[uū]l[aā][iī]|कोरिन्थीहरूलाई)|[\s\xa0]*korintʰ[iī]har[uū]l[aā][iī]|[\s\xa0]*कोरिन्थीहरूलाई|[\s\xa0]*कोरन्थी|Cor)|1\.?[\s\xa0]*कोरिन्थी|१[\s\xa0]*कोरन्थी))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Gal"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:गलाती(?:हरूलाई[\\s\\xa0]*प(?:ावलको[\\s\\xa0]*प)?त्र)?|gal[aā]t[iī]har[uū]l[aā][iī][\\s\\xa0]*patra|Gal)|(?:gal[aā]t[iī]har[uū]l[aā][iī]|गलातीहरूलाई))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Eph"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:एफिसी(?:हरूलाई[\\s\\xa0]*प(?:ावलको[\\s\\xa0]*प)?त्र)?|epʰis[iī]har[uū]l[aā][iī][\\s\\xa0]*patra|Eph)|(?:epʰis[iī]har[uū]l[aā][iī]|एफिसीहरूलाई))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Phil"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:फिलिप्पी(?:हरूलाई[\\s\\xa0]*प(?:ावलको[\\s\\xa0]*प)?त्र)?|pʰilipp[iī]har[uū]l[aā][iī][\\s\\xa0]*patra|Phil)|(?:pʰilipp[iī]har[uū]l[aā][iī]|फिलिप्पीहरूलाई))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Col"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:कलस्सी(?:हरूलाई[\\s\\xa0]*प(?:ावलको[\\s\\xa0]*प)?त्र)?|kalass[iī]har[uū]l[aā][iī][\\s\\xa0]*patra|Col)|(?:kalass[iī]har[uū]l[aā][iī]|कलस्सीहरूलाई))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ꣠-ꣷꣻ])((?:थिस्सलोनिकीहरूलाई[\s\xa0]*(?:पावलको[\s\xa0]*दोस|दोस्त)्रो[\s\xa0]*पत्र|tʰissalonik[iī]har[uū]l[aā][iī][\s\xa0]*dostro[\s\xa0]*patra|2(?:\.[\s\xa0]*(?:tʰissalonik[iī]har[uū]l[aā][iī]|थिस्सलोनिकीहरूलाई)|[\s\xa0]*(?:tʰissalonik[iī]har[uū]l[aā][iī]|थिस्सलोनिकीहरूलाई)|Thess)|2\.?[\s\xa0]*थिस्सलोनिकी))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ꣠-ꣷꣻ])((?:थिस्सलोनिकीहरूलाई[\s\xa0]*प(?:ावलको[\s\xa0]*प)?हिलो[\s\xa0]*पत्र|tʰissalonik[iī]har[uū]l[aā][iī][\s\xa0]*pahilo[\s\xa0]*patra|1(?:\.[\s\xa0]*(?:tʰissalonik[iī]har[uū]l[aā][iī]|थिस्सलोनिकीहरूलाई)|[\s\xa0]*(?:tʰissalonik[iī]har[uū]l[aā][iī]|थिस्सलोनिकीहरूलाई)|Thess)|1\.?[\s\xa0]*थिस्सलोनिकी))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2Tim"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ꣠-ꣷꣻ])((?:तिमोथीलाई[\s\xa0]*(?:पावलको[\s\xa0]*दोस|दोस्त)्रो[\s\xa0]*पत्र|timotʰ[iī]l[aā][iī][\s\xa0]*dostro[\s\xa0]*patra|2(?:\.[\s\xa0]*(?:timotʰ[iī]l[aā][iī]|तिमोथीलाई)|[\s\xa0]*(?:timotʰ[iī]l[aā][iī]|तिमोथीलाई)|Tim)|2\.?[\s\xa0]*तिमोथी))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Tim"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ꣠-ꣷꣻ])((?:तिमोथीलाई(?:र्[\s\xa0]*पावलको)?[\s\xa0]*पहिलो[\s\xa0]*पत्र|timotʰ[iī]l[aā][iī][\s\xa0]*pahilo[\s\xa0]*patra|1(?:\.[\s\xa0]*(?:timotʰ[iī]l[aā][iī]|तिमोथीलाई)|[\s\xa0]*(?:timotʰ[iī]l[aā][iī]|तिमोथीलाई)|Tim)|1\.?[\s\xa0]*तिमोथी))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Titus"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:त(?:ीतस(?:लाई[\\s\\xa0]*प(?:ावलको[\\s\\xa0]*प)?त्र)?|ितस)|t[iī]tasl[aā][iī][\\s\\xa0]*patra|Titus)|(?:t[iī]tasl[aā][iī]|तीतसलाई))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Phlm"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:फिलेमोन(?:लाई(?:[\\s\\xa0]*प(?:ावलको[\\s\\xa0]*प)?त्र)?)?|pʰilemonl[aā][iī][\\s\\xa0]*patra|pʰilemonl[aā][iī]|Phlm))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Heb"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:हिब्रूहरूको[\\s\\xa0]*निम्ति[\\s\\xa0]*पत्र|hibr[uū]har[uū]ko[\\s\\xa0]*nimti(?:[\\s\\xa0]*patra)?|हिब्रू(?:हरूको[\\s\\xa0]*निम्ति)?|Heb))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Jas"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:y[aā]k[uū]bko(?:[\\s\\xa0]*patra)?|याकूबको[\\s\\xa0]*पत्र|याकूब(?:को)?|Jas))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Pet"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ꣠-ꣷꣻ])((?:पत्रुसको[\s\xa0]*दोस्(?:त्)?रो[\s\xa0]*पत्र|patrusko[\s\xa0]*dostro[\s\xa0]*patra|2(?:\.[\s\xa0]*(?:पत्रुसको|patrusko)|[\s\xa0]*(?:पत्रुसको|patrusko)|Pet)|2\.?[\s\xa0]*पत्रुस))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Pet"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏऀ-ंऄ-ऺ़-ऽु-ै्ॐ-ॣॱ-ॷॹ-ॿḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ꣠-ꣷꣻ])((?:patrusko[\s\xa0]*pahilo[\s\xa0]*patra|पत्रुसको[\s\xa0]*पहिलो[\s\xa0]*पत्र|1(?:\.[\s\xa0]*(?:पत्रुसको|patrusko)|[\s\xa0]*(?:पत्रुसको|patrusko)|Pet)|1\.?[\s\xa0]*पत्रुस))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Jude"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:yah[uū]d[aā]ko(?:[\\s\\xa0]*patra)?|यहूदाको[\\s\\xa0]*पत्र|यहूदा(?:को)?|Jude))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Tob"],
...
(function(root) {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$c74 = "\u0930",
        peg$c75 = peg$literalExpectation("\u0930", true),

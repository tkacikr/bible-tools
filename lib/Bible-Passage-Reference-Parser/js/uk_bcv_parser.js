(function() {
  ...
  bcv_parser.prototype.regexps.range_and = "(?:[&\u2013\u2014-]|і|(?:-|до))";

  bcv_parser.prototype.regexps.range_only = "(?:[\u2013\u2014-]|(?:-|до))";
  ...
  bcv_parser.prototype.regexps.get_books = function(include_apocrypha, case_sensitive) {
    ...
    books = [
      ...
      {
        osis: ["Lev"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏЀ-ҁ҃-҇Ҋ-ԧḀ-ỿⱠ-Ɀⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Трет[яє][\s\xa0]*книга[\s\xa0]*Мо[ий]сеева|3(?:\-?(?:тє(?:\.[\s\xa0]*книга[\s\xa0]*Мо[ий]|[\s\xa0]*книга[\s\xa0]*Мо[ий])|[ае](?:\.[\s\xa0]*книга[\s\xa0]*Мо[ий]|[\s\xa0]*книга[\s\xa0]*Мо[ий]))сеева|\.[\s\xa0]*книга[\s\xa0]*Мо[ий]сеева|[\s\xa0]*(?:книга[\s\xa0]*Мо[ий]сеева|М))|III(?:\.[\s\xa0]*книга[\s\xa0]*Мо[ий]|[\s\xa0]*книга[\s\xa0]*Мо[ий])сеева|Левит|Levyt|Лев|Lev))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Num"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏЀ-ҁ҃-҇Ҋ-ԧḀ-ỿⱠ-Ɀⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Ч(?:етверта[\s\xa0]*книга[\s\xa0]*Мо[ий]сеева|ис(?:ла|л)?)|(?:IV|4)\.[\s\xa0]*книга[\s\xa0]*Мо[ий]сеева|IV[\s\xa0]*книга[\s\xa0]*Мо[ий]сеева|4[\s\xa0]*книга[\s\xa0]*Мо[ий]сеева|[CČ]ysla|Num|4[\s\xa0]*М))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Sir"],
        apocrypha: true,
      ...
      {
        osis: ["Rev"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:О(?:б['’]явл(?:ення[\\s\\xa0]*(?:св(?:\\.[\\s\\xa0]*(?:[ИЙ]о|Ів)|[\\s\\xa0]*(?:[ИЙ]о|Ів))|Ів)ана[\\s\\xa0]*Богослова)?|дкр(?:овення[\\s\\xa0]*Івана[\\s\\xa0]*Богослова|иттє))|Ob['’]javlennja[\\s\\xa0]*Ivana[\\s\\xa0]*Bohoslova|Відкриття[\\s\\xa0]*Івана|Апок(?:а(?:́лі|л[i\\xEDі])|[a\\xE1]лі)псис|Rev)|(?:Об(?:['’]явлення)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["PrMan"],
      ...
      {
        osis: ["Deut"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏЀ-ҁ҃-҇Ҋ-ԧḀ-ỿⱠ-Ɀⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:П(?:['’]ята[\s\xa0]*книга[\s\xa0]*Мо[ий]сеева|овт(?:орення|\.)?[\s\xa0]*Закону|(?:\.[\s\xa0]*?|[\s\xa0]*)?Зак|овт)|Povtorennja[\s\xa0]*Zakonu|Второзаконня|Втор|Deut|5[\s\xa0]*М))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Josh"],
      ...
      {
        osis: ["Ezra"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Книга[\\s\\xa0]*Ездри|Ездр[аи]|Ezd?ra|Єздри|Ездр?|Єзд))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Neh"],
      ...
      {
        osis: ["Ps"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Книга[\\s\\xa0]*Псалмів|Псал(?:ти́р|ми)|Псалмів|Psalmy|Пс(?:ал)?|Ps))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["PrAzar"],
      ...
      {
        osis: ["Prov"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Книга[\\s\\xa0]*При(?:повісте[ий]|казок)[\\s\\xa0]*Соломонових|Приповісте[ий][\\s\\xa0]*соломонових|При(?:тчі[\\s\\xa0]*Соломона|пові(?:док|сті)|казки|казок)|Пр(?:и(?:п(?:овісте[ий])?|тчі?))?|Pr(?:ypovisti|ov)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Eccl"],
      ...
      {
        osis: ["Jer"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Книга[\\s\\xa0]*пророка[\\s\\xa0]*Єремі[ії]|Jeremija|Єремі[яії]|Єр(?:ем)?|Jer))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Ezek"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Книга[\\s\\xa0]*пророка[\\s\\xa0]*Єзекі[ії]ля|Jezeki[i\\xEF]l['’]|Єзекі[ії]л[аья]|Єз(?:ек)?|Ezek))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Dan"],
      ...
      {
        osis: ["Joel"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Книга[\\s\\xa0]*(?:пророка[\\s\\xa0]*[ИЙ]|[ИЙ])оіла|[ИЙ]о[ії](?:ла|н)|[ИЙ]о[ії]л|Jo[ei\\xEF]l))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Amos"],
      ...
      {
        osis: ["Obad"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Книга[\\s\\xa0]*пророка[\\s\\xa0]*[АО]вдія|Овді[ийя]|O(?:vdij|bad)|Авдія|Овд?|Авд))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Jonah"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Книга[\\s\\xa0]*пророка[\\s\\xa0]*[ИЙ]они|Jonah|Jona|[ИЙ]он[аи]|[ИЙ]он))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Mic"],
      ...
      {
        osis: ["Hag"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Книга[\\s\\xa0]*(?:пророка[\\s\\xa0]*)?Огія|Аггея|Огі[ийя]|Ohij|Hag|[АО]г))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Zech"],
      ...
      {
        osis: ["Matt"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Євангелі(?:є[\\s\\xa0]*від[\\s\\xa0]*(?:св\\.?[\\s\\xa0]*Матві|Мат(?:ві|е))|я[\\s\\xa0]*від[\\s\\xa0]*(?:св\\.?[\\s\\xa0]*)?Матві)я|Jevanhelije[\\s\\xa0]*vid[\\s\\xa0]*Matvija|Від[\\s\\xa0]*Матвія|Матвія|М(?:ате[ий]|т)|Матв?|Matt))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Macc"],
      ...
      {
        osis: ["Rom"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Послання[\\s\\xa0]*(?:св\\.?[\\s\\xa0]*апостола[\\s\\xa0]*Павла[\\s\\xa0]*|апостола[\\s\\xa0]*Павла[\\s\\xa0]*)?до[\\s\\xa0]*римлян|Poslannja[\\s\\xa0]*apostola[\\s\\xa0]*Pavla[\\s\\xa0]*do[\\s\\xa0]*rymljan|До[\\s\\xa0]*римлян|Римляни|Рим(?:л(?:ян)?)?|Rom))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Cor"],
      ...
      {
        osis: ["Eph"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:По(?:слання[\\s\\xa0]*(?:св\\.?[\\s\\xa0]*апостола[\\s\\xa0]*Павла[\\s\\xa0]*|апостола[\\s\\xa0]*Павла[\\s\\xa0]*)?до[\\s\\xa0]*е|[\\s\\xa0]*слан[\\s\\xa0]*ня[\\s\\xa0]*до[\\s\\xa0]*Є)фесян|Poslannja[\\s\\xa0]*apostola[\\s\\xa0]*Pavla[\\s\\xa0]*do[\\s\\xa0]*efesjan|До[\\s\\xa0]*ефесян|Ефесяни|Еф(?:ес(?:ян)?)?|Eph|Єф))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Phil"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Послання[\\s\\xa0]*(?:св(?:\\.[\\s\\xa0]*апостола[\\s\\xa0]*Павла[\\s\\xa0]*до[\\s\\xa0]*филип['’]|[\\s\\xa0]*апостола[\\s\\xa0]*Павла[\\s\\xa0]*до[\\s\\xa0]*филип['’])|апостола[\\s\\xa0]*Павла[\\s\\xa0]*до[\\s\\xa0]*филип['’]|до[\\s\\xa0]*(?:Філіп['’]|филип['’]))ян|P(?:oslannja[\\s\\xa0]*apostola[\\s\\xa0]*Pavla[\\s\\xa0]*do[\\s\\xa0]*fylyp['’]jan|hil)|Ф(?:ил(?:ип['’]?яни|п)|лп)|Фил)|(?:(?:До[\\s\\xa0]*филип['’]|Филип['’])ян))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Col"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Послання[\\s\\xa0]*(?:св\\.?[\\s\\xa0]*апостола[\\s\\xa0]*Павла[\\s\\xa0]*до[\\s\\xa0]*к|апостола[\\s\\xa0]*Павла[\\s\\xa0]*до[\\s\\xa0]*к|до[\\s\\xa0]*К)олосян|Poslannja[\\s\\xa0]*apostola[\\s\\xa0]*Pavla[\\s\\xa0]*do[\\s\\xa0]*kolosjan|До[\\s\\xa0]*колоссян|Колосяни|Колоссян|Кол(?:ос(?:ян)?)?|Col))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Thess"],
...
(function(root) {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$c86 = "\u0434\u043E",
        peg$c87 = peg$literalExpectation("\u0434\u043E", true),
        peg$c88 = "title",
        peg$c89 = peg$literalExpectation("title", false),
        peg$c90 = function(val) { return {type:"title", value: [val], "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c91 = "from",
        peg$c92 = peg$literalExpectation("from", false),
        peg$c93 = "of",
        peg$c94 = peg$literalExpectation("of", false),
        peg$c95 = "in",
        peg$c96 = peg$literalExpectation("in", false),
        peg$c97 = "the",
        peg$c98 = peg$literalExpectation("the", false),
        peg$c99 = "book",
        peg$c100 = peg$literalExpectation("book", false),
        peg$c101 = /^[([]/,
        peg$c102 = peg$classExpectation(["(", "["], false, false),
        peg$c103 = /^[)\]]/,
        peg$c104 = peg$classExpectation([")", "]"], false, false),
        peg$c105 = function(val) { return {"type": "translation_sequence", "value": val, "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c106 = "\x1E",
        peg$c107 = peg$literalExpectation("\x1E", false),
        peg$c108 = function(val) { return {"type": "translation", "value": val.value, "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c109 = ",000",
        peg$c110 = peg$literalExpectation(",000", false),
        peg$c111 = function(val) { return {"type": "integer", "value": parseInt(val.join(""), 10), "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c112 = /^[^\x1F\x1E([]/,
        peg$c113 = peg$classExpectation(["\x1F", "\x1E", "(", "["], true, false),
        peg$c114 = function(val) { return {"type": "word", "value": val.join(""), "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c115 = function(val) { return {"type": "stop", "value": val, "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c116 = /^[\s\xa0*]/,

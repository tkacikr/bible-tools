(function() {
  ...
  bcv_parser.prototype.regexps.get_books = function(include_apocrypha, case_sensitive) {
    ...
    books = [
      ...
      {
        osis: ["Exod"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:《出(?:埃及[記记]?|谷紀)?》|Exod)|(?:《出(?:埃及[記记]|埃及|谷紀)?|出(?:埃及(?:[記记]》?|》)?|谷紀》?|》)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Bel"],
      ...
      {
        osis: ["Lev"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:《(?:肋未紀|利(?:末记|未[記记])?)》|Lev)|(?:(?:利(?:末记|未[記记])?|肋未紀)》|《(?:肋未紀|利(?:末记|未[記记])?)|利(?:末记|未[記记])?|肋未紀))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Num"],
      ...
      {
        osis: ["Isa"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:《(?:依撒意亞|以(?:赛亚书|賽(?:亞書|亚书))|[賽赛])》|Isa)|(?:《(?:依撒意亞|以(?:赛亚书|賽(?:亚书|亞書))|[賽赛])|(?:依撒意亞|[賽赛])》?|以(?:赛亚书》?|賽(?:亚书》?|亞書》?))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Sam"],
      ...
      {
        osis: ["2Chr"],
        regexp: /(^|[^0-9\\x1f])((?:《(?:編年紀|歷代志|历代志|歷|代)下》|2Chr)|(?:《(?:歷代志|历代志|編年紀|歷|代)下|(?:历代志|歷代志|代)下》?|編年紀下》?|歷下》?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Chr"],
        regexp: /(^|[^0-9\\x1f])((?:《(?:編年紀|歷代志|历代志|歷|代)上》|1Chr)|(?:(?:歷代志|历代志|編年紀|歷|代)上》|《(?:編年紀|历代志|歷(?:代志)?|代)上|(?:歷代志|历代志|編年紀|歷|代)上))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Ezra"],
      ...
      {
        osis: ["Ezek"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:《(?:厄則克耳|以西(?:结书|結[书書])|[結结])》|Ezek)|(?:(?:厄則克耳|以西(?:結[书書]|结书)|[結结])》|《(?:厄則克耳|以西(?:结书|結[书書])|[結结])|厄則克耳|以西(?:結[书書]|结书)|[結结]))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Dan"],
      ...
      {
        osis: ["Joel"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:《(?:约[珥饵]书|約珥書|岳厄爾|珥)》|Joel)|(?:《(?:约[珥饵]书|岳厄爾|約珥書|珥)|(?:岳厄爾|約珥書|珥)》?|约[珥饵]书》?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Obad"],
      ...
      {
        osis: ["Mic"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:《(?:米該亞|彌迦書|弥(?:迦书)?|彌)》|Mic)|(?:《(?:弥迦书|米該亞|彌迦書)|(?:弥迦书|彌迦書)》?|米該亞》?|《[弥彌]|弥》|彌》|弥|彌))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Nah"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:《(?:那(?:鸿书|鴻[书書])|納鴻|[鴻鸿])》|Nah)|(?:(?:那(?:鸿书|鴻[书書])|納鴻|[鴻鸿])》|《(?:那(?:鸿书|鴻[书書])|納鴻|[鴻鸿])|那(?:鸿书|鴻[书書])|納鴻|[鴻鸿]))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Hab"],
      ...
      {
        osis: ["Hag"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:《(?:哈(?:该书|該[书書]|蓋)|[該该])》|Hag)|(?:(?:哈(?:该书|該[书書]|蓋)|[該该])》|《(?:哈(?:该书|該[书書]|蓋)|[該该])|哈(?:该书|該[书書]|蓋)|[該该]))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Mal"],
      ...
      {
        osis: ["Gal"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:《(?:迦拉達書|戛拉提亞|加(?:拉太[书書])?)》|Gal)|(?:《(?:迦拉達書|戛拉提亞|加拉太[书書]|加)|(?:迦拉達書|戛拉提亞)》?|加(?:拉太[书書]》?|》)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Zech"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:《(?:撒(?:迦利(?:亞書|亚书|亞)|加利亞書)|匝加利亞|[亚亞])》|Zech)|(?:《(?:撒(?:加利亞書|迦利(?:亞書|亚书))|撒迦利亞|匝加利亞|[亚亞])|撒(?:加利亞書》?|迦利(?:亞(?:書》?|》)?|亚书》?))|(?:匝加利亞|[亚亞])》?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Matt"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:《(?:[馬马]太福音|瑪(?:竇福音|特斐)|太)》|Matt)|(?:(?:[馬马]太福音|瑪(?:竇福音|特斐)|太)》|《(?:瑪竇福音|[馬马]太福音|瑪特斐|太)|[馬马]太福音|瑪(?:竇福音|特斐)|太))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Mark"],
      ...
      {
        osis: ["1John"],
        regexp: /(^|[^0-9\\x1f])((?:《(?:约(?:翰[一壹]书|壹)|若望一書|約(?:翰[一壹]書|壹)|伊望第一)》|1John)|(?:《(?:若望一書|約(?:翰[一壹]書|壹)|约(?:翰[一壹]书|壹)|伊望第一)|(?:伊望第一|若望一書|約(?:翰[一壹]書|壹))》?|约(?:翰[一壹]书》?|壹》?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2John"],
        regexp: /(^|[^0-9\\x1f])((?:《(?:约(?:翰[二贰]书|贰)|若望二書|約(?:翰[二貳]書|[貳贰])|伊望第二)》|2John)|(?:《(?:伊望第二|约(?:翰[二贰]书|贰)|若望二書|約(?:翰[二貳]書|[貳贰]))|(?:伊望第二|约(?:翰[二贰]书|贰))》?|若望二書》?|約(?:翰[二貳]書》?|[貳贰]》?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["3John"],
        regexp: /(^|[^0-9\\x1f])((?:《(?:约(?:翰[三叁]书|[三叁])|若望三書|約(?:翰[三參]書|[三叁])|伊望第三)》|3John)|(?:(?:伊望第三|若望三書|約(?:翰[三參]書|[三叁])|约(?:翰[三叁]书|[三叁]))》|《(?:伊望第三|若望三書|約(?:翰[三參]書|[三叁])|约(?:翰[三叁]书|[三叁]))|伊望第三|若望三書|約(?:翰[三參]書|[三叁])|约(?:翰[三叁]书|[三叁])))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["John"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:《(?:若望福音|[約约](?:翰福音)?|伊望)》|John)|(?:(?:[約约]翰福音|若望福音|伊望|[約约])》|《(?:若望福音|[約约](?:翰福音)?|伊望)|[約约]翰福音|若望福音|伊望|[約约]))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Rom"],
      ...
      {
        osis: ["2Cor"],
        regexp: /(^|[^0-9\\x1f])((?:《(?:适凌爾福後|[格歌]林多後書|哥林多(?:後書|后书)|林[后後])》|2Cor)|(?:(?:适凌爾福後|[格歌]林多後書|哥林多(?:後書|后书)|林[后後])》|《(?:适凌爾福後|[格歌]林多後書|哥林多(?:後書|后书)|林[后後])|适凌爾福後|[格歌]林多後書|哥林多(?:後書|后书)|林[后後]))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Cor"],
        regexp: /(^|[^0-9\\x1f])((?:《(?:(?:适凌爾福|林)前|[格歌]林多前書|哥林多前[书書])》|1Cor)|(?:《(?:(?:适凌爾福|林)前|[格歌]林多前書|哥林多前[书書])|(?:(?:适凌爾福|林)前|[格歌]林多前書)》?|哥林多前[书書]》?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Eph"],
      ...
      {
        osis: ["Phil"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:《(?:腓立比[书書]|斐理伯書|肥利批|腓)》|Phil)|(?:《(?:腓立比[书書]|斐理伯書|肥利批|腓)|(?:斐理伯書|肥利批)》?|腓(?:立比[书書]》?|》)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Col"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:《(?:歌罗西书|歌羅西書|哥羅森書|适羅斯|西)》|Col)|(?:《(?:哥羅森書|歌(?:羅西書|罗西书)|适羅斯|西)|哥羅森書》?|歌(?:罗西书》?|羅西書》?)|(?:适羅斯|西)》?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["GkEsth"],
      ...
      {
        osis: ["Eccl"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:《(?:訓道篇|傳道書|传(?:道书)?|傳)》|Eccl)|(?:(?:訓道篇|传道书|傳(?:道書)?|传)》|《(?:传道书|訓道篇|傳(?:道書)?|传)|訓道篇|传道书|傳(?:道書)?|传))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Thess"],
        regexp: /(^|[^0-9\\x1f])((?:《(?:帖(?:撒(?:羅尼迦後書|罗尼迦后书)|[后後])|得撒洛尼後書|莎倫後)》|2Thess)|(?:(?:帖(?:撒(?:罗尼迦后书|羅尼迦後書)|[后後])|得撒洛尼後書|莎倫後)》|《(?:帖(?:撒(?:羅尼迦後書|罗尼迦后书)|[后後])|得撒洛尼後書|莎倫後)|帖(?:撒(?:罗尼迦后书|羅尼迦後書)|[后後])|得撒洛尼後書|莎倫後))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Thess"],
        regexp: /(^|[^0-9\\x1f])((?:《(?:帖(?:撒(?:羅尼迦前書|罗尼迦前书)|前)|得撒洛尼前書|莎倫前)》|1Thess)|(?:《(?:帖(?:撒(?:羅尼迦前書|罗尼迦前书)|前)|得撒洛尼前書|莎倫前)|帖(?:撒(?:羅尼迦前書》?|罗尼迦前书》?)|前》?)|(?:得撒洛尼前書|莎倫前)》?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2Tim"],
        regexp: /(^|[^0-9\\x1f])((?:《(?:提(?:摩(?:太后书|斐後)|摩太後書|[后後])|弟茂德後書)》|2Tim)|(?:(?:弟茂德後書|提(?:摩(?:太(?:後書|后书)|斐後)|[后後]))》|《(?:提(?:摩(?:太后书|斐後)|摩太後書|[后後])|弟茂德後書)|弟茂德後書|提(?:摩(?:太(?:後書|后书)|斐後)|[后後])))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Tim"],
        regexp: /(^|[^0-9\\x1f])((?:《(?:提(?:摩(?:太前[书書]|斐前)|前)|弟茂德前書)》|1Tim)|(?:(?:弟茂德前書|提(?:摩(?:太前[书書]|斐前)|前))》|《(?:弟茂德前書|提(?:摩(?:太前[书書]|斐前)|前))|弟茂德前書|提(?:摩(?:太前[书書]|斐前)|前)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Titus"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:《(?:提多[书書]|提特書|弟鐸書|多)》|Titus)|(?:《(?:弟鐸書|提(?:多[书書]|特書)|多)|(?:弟鐸書|多)》?|提(?:特書》?|多[书書]》?)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Phlm"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:《(?:費肋孟書|腓利(?:门书|門書)|肥利孟|[門门])》|Phlm)|(?:《(?:腓利门书|腓利門書|費肋孟書|肥利孟|[門门])|(?:腓利门书|肥利孟|[門门])》?|腓利門書》?|費肋孟書》?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Heb"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:《(?:耶烏雷爾|希伯(?:来书|來[书書])|[來来])》|Heb)|(?:《(?:希伯(?:來[书書]|来书)|耶烏雷爾|[來来])|(?:耶烏雷爾|[來来])》?|希伯(?:來[书書]》?|来书》?)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Jas"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:《(?:雅(?:各(?:伯書|[书書]))?|亞适烏)》|Jas)|(?:(?:雅(?:各(?:伯書|[书書]))?|亞适烏)》|《(?:雅(?:各(?:伯書|[书書]))?|亞适烏)|雅(?:各(?:伯書|[书書]))?|亞适烏))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Pet"],
        regexp: /(^|[^0-9\\x1f])((?:《(?:伯多祿後書|撇特爾後|彼(?:得后书|[后後])|彼得後書)》|2Pet)|(?:《(?:伯多祿後書|撇特爾後|彼(?:得后书|[后後])|彼得後書)|伯多祿後書》?|(?:彼(?:得后书|[后後])|撇特爾後)》?|彼得後書》?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Pet"],
        regexp: /(^|[^0-9\\x1f])((?:《(?:伯多祿前書|撇特爾前|彼(?:得前[书書]|前))》|1Pet)|(?:(?:伯多祿前書|撇特爾前|彼(?:得前[书書]|前))》|《(?:伯多祿前書|彼(?:得前[书書]|前)|撇特爾前)|伯多祿前書|撇特爾前|彼(?:得前[书書]|前)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Jude"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:《(?:猶[大達]書|犹大书|伊屋達|[犹猶])》|Jude)|(?:(?:猶[大達]書|伊屋達|犹(?:大书)?|猶)》|《(?:伊屋達|犹大书|猶(?:[大達]書)?|犹)|猶[大達]書|伊屋達|犹(?:大书)?|猶))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Bar"],
      ...
      {
        osis: ["Josh"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:《(?:若蘇厄書|约书亚记|約書亞記|[书書])》|Josh)|(?:(?:约书亚记|約書亞記|若蘇厄書|[书書])》|《(?:約書亞記|若蘇厄書|约书亚记|[书書])|约书亚记|約書亞記|若蘇厄書|[书書]))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      }
    ];

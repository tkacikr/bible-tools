(function() {
  ...
  bcv_parser.prototype.regexps.get_books = function(include_apocrypha, case_sensitive) {
    ...
    books = [
      ...
      {
        osis: ["Gen"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:בר(?:אשית|יאה)|Gen))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Exod"],
      ...
      {
        osis: ["Rev"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:חזון[\\s\\xa0]*יוחנן|הה?תגלות|Rev))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["PrMan"],
      ...
      {
        osis: ["Josh"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:יהושע|Josh))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Judg"],
      ...
      {
        osis: ["Mal"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:מלאכי|Mal))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Matt"],
      ...
      {
        osis: ["Luke"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:הבשורה[\\s\\xa0]*על(?:\\-?פי[\\s\\xa0]*לוקא?|[\\s\\xa0]*פי[\\s\\xa0]*לוק)ס|Luke|לוקס))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["1John"],
      ...
      {
        osis: ["2John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏ֑-ֽֿׁ-ׂׄ-ׇׅא-תװ-ײḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:א(?:גרתו[\s\xa0]*השנייה[\s\xa0]*של[\s\xa0]*יוחנן[\s\xa0]*השליח|יגרת[\s\xa0]*יוחנן[\s\xa0]*השנייה)|השנייה[\s\xa0]*יוחנן|2(?:[\s\xa0]*ליוחנן|John)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["3John"],
      ...
      {
        osis: ["Rom"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:א(?:גרת[\\s\\xa0]*פולוס[\\s\\xa0]*השליח[\\s\\xa0]*אל\\-?הרומיי|ל[\\s\\xa0]*הרומ(?:יי?|אי))ם|האיגרת[\\s\\xa0]*אל[\\s\\xa0]*הרומאים|Rom))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏ֑-ֽֿׁ-ׂׄ-ׇׅא-תװ-ײḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:אגרת[\s\xa0]*פולוס[\s\xa0]*השנייה[\s\xa0]*אל\-?הקור(?:נתים|ינ)|ה(?:איגרת[\s\xa0]*השנייה[\s\xa0]*אל[\s\xa0]*הקורי|שנייה[\s\xa0]*אל[\s\xa0]*הקורי?)נתים|2Cor))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏ֑-ֽֿׁ-ׂׄ-ׇׅא-תװ-ײḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:אגרת[\s\xa0]*פולוס[\s\xa0]*הראשונה[\s\xa0]*אל\-?הקור(?:נתים|י)|ה(?:איגרת[\s\xa0]*הראשונה[\s\xa0]*אל[\s\xa0]*הקורי|ראשונה[\s\xa0]*אל[\s\xa0]*הקורי?)נתים|1Cor))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Gal"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:א(?:גרת[\\s\\xa0]*פולוס[\\s\\xa0]*השליח[\\s\\xa0]*אל\\-?|ל[\\s\\xa0]*)הגלטים|האיגרת[\\s\\xa0]*אל[\\s\\xa0]*הגלטים|Gal))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Eph"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:א(?:גרת[\\s\\xa0]*פולוס[\\s\\xa0]*השליח[\\s\\xa0]*אל(?:[\\s\\xa0]*האפסי|\\-?האפס)|ל[\\s\\xa0]*האפס)ים|האיגרת[\\s\\xa0]*אל[\\s\\xa0]*האפסים|השליח[\\s\\xa0]*אל[\\s\\xa0]*האפסיים|Eph))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Phil"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:א(?:גרת[\\s\\xa0]*פולוס[\\s\\xa0]*השליח[\\s\\xa0]*אל\\-?הפיליפי(?:ים)?|ל[\\s\\xa0]*הפיליפיי?ם)|האיגרת[\\s\\xa0]*אל[\\s\\xa0]*הפיליפים|Phil))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Col"],
      ...
      {
        osis: ["2Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏ֑-ֽֿׁ-ׂׄ-ׇׅא-תװ-ײḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:אגרת[\s\xa0]*פולוס[\s\xa0]*השנייה[\s\xa0]*אל\-?התסלונ(?:יקים)?|ה(?:איגרת[\s\xa0]*השנייה[\s\xa0]*אל[\s\xa0]*|שנייה[\s\xa0]*אל[\s\xa0\-?]*)התסלוניקים|2Thess))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏ֑-ֽֿׁ-ׂׄ-ׇׅא-תװ-ײḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:אגרת[\s\xa0]*פולוס[\s\xa0]*הראשונה[\s\xa0]*אל\-?התסלו(?:ניקים)?|ה(?:איגרת[\s\xa0]*ה)?ראשונה[\s\xa0]*אל[\s\xa0]*התסלוניקים|1Thess))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["2Tim"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏ֑-ֽֿׁ-ׂׄ-ׇׅא-תװ-ײḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:אגרת[\s\xa0]*פולוס[\s\xa0]*השנייה[\s\xa0]*אל\-?טימותי(?:וס)?|ה(?:איגרת[\s\xa0]*השנייה[\s\xa0]*אל[\s\xa0]*טימותי|שנייה[\s\xa0]*אל[\s\xa0]*טימותיא?)וס|2Tim))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["1Tim"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏ֑-ֽֿׁ-ׂׄ-ׇׅא-תװ-ײḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:א(?:ל[\s\xa0]*טימותיאוס[\s\xa0]*אגרת[\s\xa0]*פולוס[\s\xa0]*הראשונה|גרת[\s\xa0]*פולוס[\s\xa0]*הראשונה[\s\xa0]*אל\-?טימות)|ה(?:איגרת[\s\xa0]*הראשונה[\s\xa0]*אל[\s\xa0]*טימותי|ראשונה[\s\xa0]*אל[\s\xa0]*טימותיא?)וס|טימותיאוס[\s\xa0]*(?:אל|1)|1[\s\xa0]*טימותיאוס|1Tim))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      },
      {
        osis: ["Titus"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:א(?:גרת[\\s\\xa0]*פולוס[\\s\\xa0]*אל\\-?|ל[\\s\\xa0]*)טיטוס|האיגרת[\\s\\xa0]*אל[\\s\\xa0]*טיטוס|Titus))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Phlm"],

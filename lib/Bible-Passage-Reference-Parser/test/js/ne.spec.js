(function() {
  ...
  describe("Localized book Lev (ne)", function() {
    ...
    return it("should handle book: Lev (ne)", function() {
		...
		expect(p.parse("लेबी 1:1").osis()).toEqual("Lev.1.1")
  ...
  describe("Localized book 2Sam (ne)", function() {
    ...
    it("should handle book: 2Sam (ne)", function() {
		...
		expect(p.parse("2 शमूएलको 1:1").osis()).toEqual("2Sam.1.1")
		expect(p.parse("2 शमूएलले 1:1").osis()).toEqual("2Sam.1.1")
		expect(p.parse("2. शामुएल 1:1").osis()).toEqual("2Sam.1.1")
		expect(p.parse("२ शमूएलले 1:1").osis()).toEqual("2Sam.1.1")
		expect(p.parse("2 शामुएल 1:1").osis()).toEqual("2Sam.1.1")
    ...
    return it("should handle non-Latin digits in book: 2Sam (ne)", function() {
      p.set_options({
  ...
  describe("Localized book 1Sam (ne)", function() {
    ...
    it("should handle book: 1Sam (ne)", function() {
		...
		expect(p.parse("1 शमूएलको 1:1").osis()).toEqual("1Sam.1.1")
		expect(p.parse("1 शमूएलले 1:1").osis()).toEqual("1Sam.1.1")
		expect(p.parse("1. शामुएल 1:1").osis()).toEqual("1Sam.1.1")
		expect(p.parse("१ शमूएलले 1:1").osis()).toEqual("1Sam.1.1")
		expect(p.parse("1 शामुएल 1:1").osis()).toEqual("1Sam.1.1")
    ...
    return it("should handle non-Latin digits in book: 1Sam (ne)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book Neh (ne)", function() {
    ...
    return it("should handle book: Neh (ne)", function() {
		...
		expect(p.parse("नेहमिया 1:1").osis()).toEqual("Neh.1.1")
  ...
  describe("Localized book Hag (ne)", function() {
    ...
    return it("should handle book: Hag (ne)", function() {
		...
		expect(p.parse("हग्गै 1:1").osis()).toEqual("Hag.1.1")
  ...
  describe("Localized book 2Cor (ne)", function() {
    ...
    it("should handle book: 2Cor (ne)", function() {
		...
		expect(p.parse("2 कोरिन्थी 1:1").osis()).toEqual("2Cor.1.1")
		expect(p.parse("2 कोरन्थी 1:1").osis()).toEqual("2Cor.1.1")
		expect(p.parse("२ कोरन्थी 1:1").osis()).toEqual("2Cor.1.1")
		expect(p.parse("2Cor 1:1").osis()).toEqual("2Cor.1.1")
		;
      return true;
    });
    return it("should handle non-Latin digits in book: 2Cor (ne)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Localized book 1Cor (ne)", function() {
    ...
    it("should handle book: 1Cor (ne)", function() {
		...
		expect(p.parse("1 कोरिन्थी 1:1").osis()).toEqual("1Cor.1.1")
		expect(p.parse("1 कोरन्थी 1:1").osis()).toEqual("1Cor.1.1")
		expect(p.parse("१ कोरन्थी 1:1").osis()).toEqual("1Cor.1.1")
		expect(p.parse("1Cor 1:1").osis()).toEqual("1Cor.1.1")
		;
      return true;
    });
    return it("should handle non-Latin digits in book: 1Cor (ne)", function() {
      p.set_options({
        non_latin_digits_strategy: "replace"
      });
  ...
  describe("Miscellaneous tests", function() {
    ...
    it("should handle 'and' (ne)", function() {
      ...
      expect(p.parse("Exod 1:1 र 3").osis()).toEqual("Exod.1.1,Exod.1.3");
      return expect(p.parse("Phlm 2 र 6").osis()).toEqual("Phlm.1.2,Phlm.1.6");
    });

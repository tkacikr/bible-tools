		...
		(
			...
			\x1f(\d+)(?:/\d+)?\x1f		#book
				(?:
				  ...
				  | y#{bcv_parser::regexps.space}+siguientes | y(?!#{bcv_parser::regexps.space}+sig) | y#{bcv_parser::regexps.space}+sig | vers[íi]culos | cap[íi]tulos | vers[íi]culo | cap[íi]tulo | caps | vers | cap | ver | vss | al | vs | vv | á | v
...
bcv_parser::regexps.range_and = "(?:[&\u2013\u2014-]|y(?!#{bcv_parser::regexps.space}+sig)|(?:á|al))"
bcv_parser::regexps.range_only = "(?:[\u2013\u2014-]|(?:á|al))"
